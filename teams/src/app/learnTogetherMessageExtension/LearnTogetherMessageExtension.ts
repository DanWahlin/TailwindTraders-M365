...
@PreventIframe("/learnTogetherMessageExtension/config.html")
@PreventIframe("/learnTogetherMessageExtension/action.html")
export default class LearnTogetherMessageExtension implements IMessagingExtensionMiddlewareProcessor {
