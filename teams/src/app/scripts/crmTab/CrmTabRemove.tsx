...
export interface ICrmTabRemoveState extends ITeamsBaseComponentState {
    value: string;
}
export interface ICrmTabRemoveProps {

}

/**
 * Implementation of CRM remove page
 */
export class CrmTabRemove  extends TeamsBaseComponent<ICrmTabRemoveProps, ICrmTabRemoveState> {
