...
3. Give the bot a handle (ex: `crmBot`), choose your subscription and resource group
4. For the messaging endpoint, use this: `https://learntogethercrm.azurewebsites.net/api/messages`
