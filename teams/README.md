# Learn Together CRM - Microsoft Teams App

Generate a Microsoft Teams application.

## Minimal Path to Awesome

1. Create `.env` file. Update IDs with your values:

```text
# The domain name of where you host your application
HOSTNAME=learntogethercrm.azurewebsites.net

# Id of the Microsoft Teams application
APPLICATION_ID=b7504d30-2432-11eb-b7e4-570a97dd6c62
# Package name of the Microsoft Teams application
PACKAGE_NAME=learntogethercrm
...
CRM_APP_ID=a1695d4d-84c0-4750-be9b-e049c9c68f19
CRM_APP_URI=api://learntogethercrm.ngrok.io/a1695d4d-84c0-4750-be9b-e049c9c68f19
```
...
3. Create a new *Web App* with Windows App Service Plan and give it the name of your tab, the same you used when asked for URL in the Yeoman generator. In your case https://learntogethercrm.azurewebsites.net.
...
11. Run the following command to set up the remote repository: `git remote add azure https://<username>@learntogethercrm.scm.azurewebsites.net:443/learntogethercrm.git`. You need to replace <username> with the username of the App Credentials you retrieved in _Deployment Credentials_. You can also copy the URL from *Options* in the Azure Web App.
...
13. Wait until the deployment is completed and navigate to https://learntogethercrm.azurewebsites.net/privacy.html to test that the web application is running
14. Done
